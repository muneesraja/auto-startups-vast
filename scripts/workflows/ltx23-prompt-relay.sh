#!/bin/bash
# ---
# name: LTX 2.3 Prompt Relay (old man & red panda)
# aliases: [ltx23-prompt-relay, prompt-relay-ltx23, ltx23-oldman-redpanda]
# description: Download LTX 2.3 models for prompt relay workflow - old man & red panda video generation
# size: ~61.4GB
# min_vram: 24GB
# ---
set -e
