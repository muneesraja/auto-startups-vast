Create a lean character identity sheet for use as an image-edit reference.
Match episode Tone (`grounded` cinematic 3D or `stylized`). Maximize character
pixels; minimize UI chrome, white empty space, and text.
...
Neutral production stance. Match Tone; do not default to cute Pixar.
...
3. EXPRESSION SHEET
────────────────────────────────────────
Head-and-shoulders expression grid. Same face geometry in every cell; only emotion changes.

Expressions (arranged left-to-right in two compact rows on the 16:9 sheet):
• Neutral
• Alert
• Fear
• Protect / determined
...
4. ACCESSORIES
────────────────────────────────────────
Small visual close-ups of key accessories / costume details only (not color swatches), arranged left-to-right in a strip:
{accessories}
