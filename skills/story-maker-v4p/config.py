"""Trimmed config for story-maker-v4p.

story-maker-v4p has NO agent framework and NO LiteLLM: Claude Code is the brain
...
DEFAULT_OUTPUT_BASE_DIR = os.getenv(
    ...
    os.path.join(workspace_root, "outputs", "story-maker-v4p"),
)
