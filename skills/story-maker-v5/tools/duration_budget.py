...
PANELS_MIN = 6   # minimum / default grid: 3x2 or 2x3 (6 panels)
...
H3_RECOMMENDED_MAX_SHOT_SECONDS = 15.0  # Dynamic depth: slow-paced single takes can extend up to full generation limit
