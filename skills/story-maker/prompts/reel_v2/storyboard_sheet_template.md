...
• Portrait **9:16** page
• Exactly a **5 rows × 2 columns** grid (row-major: left→right, top→bottom)
...
Warm natural colors
Photo-album contact sheet of 16:9 stills on a 9:16 page
