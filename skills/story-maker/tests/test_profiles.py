...
class TestStyleProfiles(unittest.TestCase):
    def test_get_profile(self):
        ...
        self.assertEqual(cinematic.min_shot_seconds, 6)
        self.assertEqual(cinematic.max_shot_seconds, 10)
        self.assertEqual(reels.default_target_seconds, 30)
        self.assertEqual(reels.min_shot_seconds, 6)
        self.assertEqual(reels.max_shot_seconds, 10)
