...
def generate_ltx_video(ff_image_path: str, lf_image_path: str, motion_prompt: str, output_path: str, duration_seconds: int = 8) -> dict:
    ...
    Args:
        ...
        duration_seconds (int): Duration in seconds (6-12, default 8).
    """
    try:
        # 1. Upload files
        ...
        # 2. Load template
        workflow_template = load_workflow_template("ltx-23-flf2v", config.WORKFLOWS_DIR)
        ...
        shot_for_builder = {
            ...
            "_builder_mode": "ltx_fflf_flf2v"
        }

        # Generate custom config mapping for 1280x720 24fps
        global_cfg = {
            "width": 1280,
            "height": 720,
            "seed_base": 42,
