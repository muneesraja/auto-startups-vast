...
def organize_waves(output_dir: str):
    ...
    for shot_id in wave1_shot_ids:
        ...
        if shot_id in prompts.get("consistency_patches", {}):
            wave1_payload["consistency_patches"][shot_id] = prompts["consistency_patches"][shot_id]
    ...
    # Wave 2 shots generations (they inherit FF from Wave 1 video last frames)
